...
//251366/729305/2.49/4/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AZ1117IH-3.3TRG1" (originalName "AZ1117IH-3.3TRG1")
	...
	(compDef "AZ1117IH-3.3TRG1" (originalName "AZ1117IH-3.3TRG1") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AZ1117IH-3.3TRG1"))
		...
		(attr "Mouser Part Number" "621-AZ1117IH-3.3TRG1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/AZ1117IH-3.3TRG1?qs=cpo3%2FpBou2jnS4SxLgAVoA%3D%3D")
		(attr "Manufacturer_Name" "Diodes Inc.")
		(attr "Manufacturer_Part_Number" "AZ1117IH-3.3TRG1")
		(attr "Description" "LDO Voltage Regulators LDO BJT HiCurr 1.35A 10Hz to 10KHz")
		(attr "<Hyperlink>" "")
		(attr "<Component Height>" "1.8")
		(attr "<STEP Filename>" "AZ1117IH-3.3TRG1.stp")

...
//1045622/729305/2.49/9/4/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "BDJ0GC0WEFJ-E2" (originalName "BDJ0GC0WEFJ-E2")
	...
	(compDef "BDJ0GC0WEFJ-E2" (originalName "BDJ0GC0WEFJ-E2") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "VO") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "VO_S") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "BDJ0GC0WEFJ-E2"))
		...
		(attr "Mouser Part Number" "755-BDJ0GC0WEFJ-E2")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=755-BDJ0GC0WEFJ-E2")
		(attr "Manufacturer_Name" "ROHM Semiconductor")
		(attr "Manufacturer_Part_Number" "BDJ0GC0WEFJ-E2")
		(attr "Description" "1A Variable / Fixed Output LDO Regulator")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/BDJ0GC0WEFJ-E2.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "BDJ0GC0WEFJ-E2.stp")

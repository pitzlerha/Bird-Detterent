...
(library Library_1
	...
	(symbolDef "16TRV470M10X10.5" (originalName "16TRV470M10X10.5")
	...
	(compDef "16TRV470M10X10.5" (originalName "16TRV470M10X10.5") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "16TRV470M10X10.5"))
		...
		(attr "<Hyperlink>" "http://www.rubycon.co.jp/en/catalog/e_pdfs/aluminum/e_TRV.pdf")
		(attr "<Component Height>" "10.5")
		(attr "<STEP Filename>" "16TRV470M10X10.5.stp")
